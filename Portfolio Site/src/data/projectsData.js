export const projectsData = [
  {
    ...
    description: 'Full-stack e-commerce platform with payment integration, user authentication, and real-time inventory management.',
    shortDescription: 'A complete online store solution',
    image: 'https://via.placeholder.com/500x300?text=E-Commerce+Platform',
    tags: ['React', 'Node.js', 'MongoDB', 'Stripe'],
    featured: true,
    challenge: 'Build a scalable e-commerce platform that handles high traffic, secure payments, and real-time inventory updates without downtime.',
    solution: 'Implemented a microservices architecture with React frontend, Node.js/Express backend, and MongoDB database. Integrated Stripe for secure payments and implemented WebSocket connections for real-time inventory synchronization.',
    results: [
      'Processes 1000+ transactions daily',
      '99.9% uptime achieved',
      'Reduced load times by 45% with optimization',
      '10,000+ registered users'
    ],
    technologies: {
      frontend: ['React', 'Redux', 'CSS3', 'Vite'],
  ...
  },
  {
    ...
    image: 'https://via.placeholder.com/500x300?text=Task+Management',
  ...
  },
  {
    ...
    image: 'https://via.placeholder.com/500x300?text=Social+Analytics',
  ...
  },
  {
    ...
    image: 'https://via.placeholder.com/500x300?text=CMS',
  ...
  },
  {
    ...
    image: 'https://via.placeholder.com/500x300?text=Portfolio+Generator',
